...
image_path = "D:/data/mask_face/wider_face/WIDER_val/images/"
label_path = "D:/data/mask_face/wider_face/wider_face_split/wider_face_val_bbx_gt.txt"
...
def main():
    ...
    for i in lines:
        ...
        if ".jpg" in i:
            ...
            img_path = i.split("/n")[0]
            img_path = image_base_path + img_path
